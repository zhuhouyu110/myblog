...
$others_seo = $nc_option['others_seo'] ?? array();

if ($others_seo['noindex_author_page'] ?? false) {
...
if ($others_seo['auto_tag_link_switcher'] ?? false) {
...
if ($others_seo['baidu_submit'] ?? false) {
