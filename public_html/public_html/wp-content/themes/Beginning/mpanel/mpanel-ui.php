...
$this->before( __( '幻灯设置', 'Bing' ) );
	...
	$this->group( __( '首页幻灯片', 'Bing' ), 'slider_home' );
		...
		$this->item( array(
			...
			'type'    => 'checkbox',
			'help'    => __( '自动切换幻灯片', 'Bing' ),
			'show'    => 'slider_home_auto_play_speed',
			'default' => true
		) );
		...
		$this->item( array(
			...
			'max'     => 1000,
			'unit'    => __( '毫秒', 'Bing' ),
			'help'    => __( '幻灯片在切换时候的动画执行速度，设置太大会显得迟钝' ),
			'default' => 250
		) );
		...
		$this->item( array(
			...
			'option'  => array(
				...
				'sticky'        => __( '置顶文章', 'Bing' ),
				'rand'          => __( '随机文章', 'Bing' ),
				'comment_count' => __( '热门文章（评论）', 'Bing' ),
				'view_count'    => __( '热门文章（浏览）', 'Bing' ),
				'category'      => __( '分类文章', 'Bing' )
			),
			'help'    => __( '选择幻灯片内容', 'Bing' ),
			'show'    => array( 'category' => 'slider_home_query_categories' ),
			'default' => 'new'
		) );
...
$this->before( __( '优化配置', 'Bing' ) );
	...
	$this->group( __( '文章', 'Bing' ) );
		 ...
		 */
		$this->item( array(
			'name'    => __( '移动端文章页折叠', 'Bing' ),
			'id'      => 'mobile_single_collapse',
			'type'    => 'checkbox',
			'help'    => __( '在移动端查看文章页时，把内容、评论和分类折叠到三个标签栏里，通过点击进行切换，类似于 App Store。', 'Bing' ),
			'default' => true
		) );
